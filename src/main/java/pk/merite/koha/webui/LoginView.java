...
public class LoginView extends JDialog implements HyperlinkListener {
    
    public static final LoginView frame = new LoginView();
    ...
    public class HtmlFormView extends FormView {
        protected Component createComponent() {
            ...
            if (c instanceof JButton) {
                ...
                btn.setFont(LoginView.defaultMenuFont);
                ...
                ((JScrollPane)c).getViewport().getView().setFont(LoginView.defaultMenuFont);
            }
    ...
    public LoginView() {
        ...
        try {
            editor.setPage(new URL("file:/" + new File("Login.html").getAbsolutePath()));
        } catch (Exception e) {
        }
    }
    ...
    public void setPage(String page, JEditorPane editor) {
        ...
        try {
            if(header == null) {
                header = "<HTML><BODY><TABLE><TR><TD width='40'></TD><TD>";
            }
    ...
    public static void main(String args[]) {
        try {
            ...
            frame.setPage("Login.html", frame.editor);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
